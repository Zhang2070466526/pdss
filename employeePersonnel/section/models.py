...
#     employee_dim_reason = models.ForeignKey(to=HrDimissionReason, on_delete=models.DO_NOTHING, db_constraint=False,
#                                             null=True,
#                                             blank=True,
#                                             verbose_name='离职原因')
#     employee_dim_type = models.ForeignKey(to=HrDimissionType, on_delete=models.DO_NOTHING, db_constraint=False,
#                                           null=True,
#                                           blank=True,
#                                           verbose_name='离职类型')
...
#     employee_record_type = models.CharField(max_length=10, null=True, blank=True, choices=(('1', '周'), ('2', '月')),
#                                             verbose_name='记录类型')
#
#     class Meta:
#         managed = True
